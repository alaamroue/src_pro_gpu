...
class CDomain : public CDomainBase
{
	...
	public:
		...
		virtual	void		readBuffers_h_vx_vy(double**) = 0;										// Read the gpu buffers to a double**
		virtual	void		readBuffers_opt_h(double*) = 0;											// Read the gpu buffers water depth to a double*
		virtual	void		readBuffers_v_x(double*) = 0;											// Read the gpu buffers velocity in x to a double*
		virtual	void		readBuffers_v_y(double*) = 0;											// Read the gpu buffers velocity in y to a double*
